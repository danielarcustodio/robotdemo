Vamos atualizar os arquivos para salvar as capturas de tela em uma pasta específica chamada `evidencias`.
...
Agora, todas as capturas de tela serão salvas na pasta `evidencias`. Certifique-se de que a pasta `evidencias` exista ou seja criada antes de executar os testes.